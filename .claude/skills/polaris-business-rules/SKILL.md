...
- [references/invariants-30-43.md](references/invariants-30-43.md) — the one-paragraph invariant for rules 30–49 (the filename keeps its original range: the reference is cited from code and the other skills)
