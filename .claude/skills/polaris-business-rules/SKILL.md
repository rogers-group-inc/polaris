...
- [references/invariants-30-43.md](references/invariants-30-43.md) — the one-paragraph invariant for rules 30–53 (the filename keeps its original range: the reference is cited from code and the other skills)
...
- [references/narrative-44-48.md](references/narrative-44-48.md) — full narrative, rules 44–53 (split out 2026-09-09 when the 36–43 file passed 100 KB; the filename is a stable citation key)
