...
| touch map regions, `region:` tags, or anything that strips `Asset.tags` | 52 |
...
| 52 | A region tag dies when its name is retired, and only then | invariants-30-43 | narrative-44-48 |
